...
<tr>
 ...
 <form action="comprar3.php" >
        <input type="submit" class="btn btn-warning"  value="Generar orden del último" >
</form>
        </td> 
    <td>
    <form action="comprar4.php" >
        <input type="submit" class="btn btn-warning"  value="Generar orden de todos" >
</form></td>
               </tr>
     </table>
       </div>
