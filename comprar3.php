    ...
    <table width="95%" >
      <tr>
        ...
        //while($dato=mysql_fetch_array($consulta)){
         $consulta=mysql_query("SELECT venta.CantidadV,NombreLibro,Serie FROM proveedor INNER JOIN venta WHERE proveedor.Serie=venta.NoSerie ORDER BY id_Venta DESC LIMIT 1");
        while($dato=mysql_fetch_array($consulta)){
$codigoHTML.='
      <tr>
